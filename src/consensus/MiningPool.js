...
class MiningPool {
    constructor() {
        this.WINDOW_SIZE = 100; // blocks
        this.NODE_SHARE_PERCENTAGE = 0.25; // 25% of fees go to nodes
        this.windowHistory = new Map();
        this.activeNodes = new Map(); // Current window participants
     ...
     */
    addActiveNode(nodeId, ip, walletAddress, currentBlock) {
     ...
     */
    accumulateFees(blockIndex, totalBlockFees) {
        this.checkWindowRotation(blockIndex);
        this.currentWindow.totalFeesCollected += totalBlockFees;
        this.currentWindow.nodeShare = Math.floor(this.currentWindow.totalFeesCollected * this.NODE_SHARE_PERCENTAGE);
     ...
     */
    checkWindowRotation(currentBlock) {
