...
export class RPCServer {
    ...
    private setupRoutes(): void {
        ...
        this.app.post('/api/transaction/create', this.sendTransfer.bind(this)); // Additional Alias for Netra compatibility
    ...
    private async commentContent(req: Request, res: Response): Promise<void> {
        try {
            ...
            const result = this.socialService.commentOnContent({
                ...
                signature,
                sender_public_key: public_key,
                instant: String(instant) === 'true' // Strict boolean check (handles 'false' string)
            });
